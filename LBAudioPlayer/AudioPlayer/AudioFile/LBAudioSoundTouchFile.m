...
#import "LBAudioSoundTouchFile.h"
...
@interface LBAudioSoundTouchFile (){
...
static OSStatus audioFileReadProc(void *inClientData,
                                  ...
                                  void *buffer,
                                  UInt32 *actualCount){
    LBAudioSoundTouchFile *audioFile = (__bridge LBAudioSoundTouchFile *)inClientData;
...
@implementation LBAudioSoundTouchFile
...
- (void)exportiPodMusicWithURL:(NSURL *)url cachePath:(NSString *)cachePath error:(NSError **)error{
    __weak LBAudioSoundTouchFile *weakSelf = self;
